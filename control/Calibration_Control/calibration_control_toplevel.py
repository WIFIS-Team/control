...
class MainApplication(Frame): #this class holds all of the gui into and button functions. not really sure why it's a class. Jason did it this way and I copied
	...
	def create_widgets(self): #create all the buttons and labesl and stuff
		...
		Label(self, text="Flipper 1 (In Calibration Box)", font='bold',anchor=W).grid(row=7, column=2,columnspan=2, padx=15,sticky="ew")
		...
		self.s1.grid(row=8, column=4, padx=15)


		Label(self, text="Flipper 2 (On WIFIS)", font='bold',anchor=W).grid(row=9, column=2,columnspan=2, padx=15,sticky="ew")
		...
		self.s2.grid(row=10, column=4, padx=15)
